...
router.put('/students/:id', cacheInvalidation(['api:admin/dashboard*', 'api:admin/analytics*']), adminController.updateStudent);
router.delete('/students/:id', cacheInvalidation(['api:admin/dashboard*', 'api:admin/analytics*']), adminController.deleteStudent);
...
router.post('/counselors', cacheInvalidation(['api:admin/dashboard*', 'api:admin/analytics*']), adminController.addCounselor);
router.put('/counselors/:id', cacheInvalidation(['api:admin/dashboard*', 'api:admin/analytics*']), adminController.updateCounselor);
router.patch('/counselors/:id/status', cacheInvalidation(['api:admin/dashboard*', 'api:admin/analytics*']), adminController.updateCounselorStatus);
router.delete('/counselors/:id', cacheInvalidation(['api:admin/dashboard*', 'api:admin/analytics*']), adminController.deleteCounselor);

router.get('/telecallers', adminController.getTelecallers);
router.post('/telecallers', cacheInvalidation(['api:admin/dashboard*', 'api:admin/analytics*']), adminController.addTelecaller);
router.put('/telecallers/:id', cacheInvalidation(['api:admin/dashboard*', 'api:admin/analytics*']), adminController.updateTelecaller);
router.patch('/telecallers/:id/status', cacheInvalidation(['api:admin/dashboard*', 'api:admin/analytics*']), adminController.updateTelecallerStatus);
router.delete('/telecallers/:id', cacheInvalidation(['api:admin/dashboard*', 'api:admin/analytics*']), adminController.deleteTelecaller);
...
router.post('/marketing-team', cacheInvalidation(['api:admin/dashboard*', 'api:admin/analytics*']), adminController.addMarketingTeamMember);
router.put('/marketing-team/:id', cacheInvalidation(['api:admin/dashboard*', 'api:admin/analytics*']), adminController.updateMarketingTeamMember);
router.patch('/marketing-team/:id/status', cacheInvalidation(['api:admin/dashboard*', 'api:admin/analytics*']), adminController.updateMarketingTeamMemberStatus);
router.delete('/marketing-team/:id', cacheInvalidation(['api:admin/dashboard*', 'api:admin/analytics*']), adminController.deleteMarketingTeamMember);
...
router.post('/b2b-marketing-team', cacheInvalidation(['api:admin/dashboard*', 'api:admin/analytics*']), adminController.addB2BMarketingTeamMember);
router.put('/b2b-marketing-team/:id', cacheInvalidation(['api:admin/dashboard*', 'api:admin/analytics*']), adminController.updateB2BMarketingTeamMember);
router.patch('/b2b-marketing-team/:id/status', cacheInvalidation(['api:admin/dashboard*', 'api:admin/analytics*']), adminController.updateB2BMarketingTeamMemberStatus);
router.delete('/b2b-marketing-team/:id', cacheInvalidation(['api:admin/dashboard*', 'api:admin/analytics*']), adminController.deleteB2BMarketingTeamMember);
