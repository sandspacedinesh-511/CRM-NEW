...
function CounselorManagement() {
  ...
  const filteredCounselors = counselors
    .filter(counselor => {
      ...
      const successRate = counselor.totalStudents > 0 ? 
        (counselor.successfulApplications / counselor.totalStudents) * 100 : 0;
    ...
    .sort((a, b) => {
      ...
      if (orderBy === 'successRate') {
        const rateA = a.totalStudents > 0 ? (a.successfulApplications / a.totalStudents) * 100 : 0;
        const rateB = b.totalStudents > 0 ? (b.successfulApplications / b.totalStudents) * 100 : 0;
