      ...
      <Grid container spacing={3} sx={{ mb: 2 }}>
        ...
        <Grid item xs={12} sm={6} md={4}>
          <StatCard
            ...
            value={importedLeads.length}
            subtitle="Leads marked by you"
            color={theme.palette.success.main}
          />
        </Grid>
      </Grid>
        ...
        <Grid item xs={12}>
          <Card sx={{ borderRadius: 3 }}>
            <CardHeader
              ...
              subheader="Total leads marked by you from imported call lists"
            />
            <CardContent>
              {importedLeads.length === 0 ? (
                <Box sx={{ py: 4, textAlign: 'center' }}>
                  <Typography color="text.secondary">
                    No leads have been marked yet. Mark leads from your imported tasks to see them here.
                  </Typography>
                </Box>
              ) : isMobile ? (
                <Stack spacing={2}>
                        ...
                        <Stack spacing={1}>
                          <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                            ...
                            {lead.updatedAt && (
                              <Typography variant="caption" color="text.secondary">
                                {format(new Date(lead.updatedAt), 'PP')}
                              </Typography>
                            )}
                          </Box>
                          ...
                          {lead.contactNumber && (
                            <Button
                              ...
                              sx={{ textTransform: 'none', justifyContent: 'flex-start', width: 'fit-content' }}
                            >
                              {lead.contactNumber}
                            </Button>
                          )}
                          ...
                          <Stack direction="row" spacing={1} flexWrap="wrap" useFlexGap sx={{ mt: 1 }}>
                            ...
                            {lead.leadStatus && (
                              <Chip
                                ...
                                size="small"
                                color={
                                  lead.leadStatus === 'ASSIGNED_TO_COUNSELOR'
                                    ? 'success'
                                    : 'default'
                                }
                                variant="outlined"
                          ...
                          {lead.comments && (
                            <Box sx={{ bgcolor: alpha(theme.palette.action.hover, 0.5), p: 1, borderRadius: 1, mt: 1 }}>
                              <Typography variant="caption" color="text.secondary">
                                {lead.comments}
                              </Typography>
                            </Box>
                    ...
                    <TableBody>
                      {importedLeads.map((lead) => (
                        <TableRow key={lead.id} hover>
                          ...
                          <TableCell>{lead.interestedCountry || '-'}</TableCell>
