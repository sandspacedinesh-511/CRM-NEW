...
const DOCUMENT_TYPES = [
  ...
  { value: 'OFFER_LETTER', label: 'Offer Letter', color: 'primary' },
          ...
          <Box>
            {folderView ? (
              ...
              <>
                ...
                <Paper sx={{ borderRadius: 2, overflow: 'hidden', background: 'transparent', boxShadow: 'none' }}>
                  {isMobile ? (
                    <Stack spacing={2}>
                          ...
                          <CardContent sx={{ p: 2, '&:last-child': { pb: 2 } }}>
                            <Box sx={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', mb: 2 }}>
                              ...
                              <IconButton
                                ...
                                onClick={(e) => {
                                  e.stopPropagation();
                                  // Open actions menu if needed, or just show actions row
                                }}
                              >
                                <MoreIcon />
                              </IconButton>
                            ...
                            <Box sx={{ mt: 2, display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                              <Chip
                                ...
                                variant="outlined"
                              />
                              <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, border: `1px solid ${theme.palette.divider}`, borderRadius: 1, px: 1, py: 0.5 }}>
                            ...
                            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                              ...
                              <Box sx={{ display: 'flex' }}>
                                <IconButton size="small" onClick={() => handlePreview(document)} sx={{ color: theme.palette.primary.main }}><ViewIcon fontSize="small" /></IconButton>
                                <IconButton size="small" onClick={() => handleDownload(document.id, document.name)} sx={{ color: theme.palette.text.secondary }}><DownloadIcon fontSize="small" /></IconButton>
                                <IconButton size="small" onClick={() => handleEdit(document)} sx={{ color: theme.palette.info.main }}><EditIcon fontSize="small" /></IconButton>
                                <IconButton size="small" onClick={() => handleDelete(document.id)} sx={{ color: theme.palette.error.main }}><DeleteIcon fontSize="small" /></IconButton>
                              </Box>
                            </Box>
                          </CardContent>
                        </Card>
