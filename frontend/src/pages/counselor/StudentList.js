...
function StudentList() {
  ...
  // Enrollment completion toggle: CURRENT (not enrolled), COMPLETED (enrolled in at least one country), ALL
  const [enrollmentFilter, setEnrollmentFilter] = useState('CURRENT');
    ...
    try {
      ...
      const response = await axiosInstance.get('/counselor/students', {
        params: {
          ...
          enrollmentStatus: enrollmentFilter !== 'ALL' ? enrollmentFilter : undefined,
  ...
  }, [searchTerm, phaseFilter, statusFilter, enrollmentFilter, sortBy, sortOrder, page, rowsPerPage]);
