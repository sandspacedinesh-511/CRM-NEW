        ...
        <Grid container spacing={4} sx={{ mb: 4 }}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <StatCard
              ...
              value={dashboardData.stats.completedEnrollments || 0}
              icon={<CheckCircleIcon sx={{ fontSize: 28, color: theme.palette.info.main }} />}
              color={theme.palette.info.main}
              subtitle="Students completed"
              trend={0}
              badge={dashboardData.stats.completedEnrollments > 0 ? dashboardData.stats.completedEnrollments : null}
              onClick={() => navigate('/counselor/students')}
            />
          </Grid>
          <Grid item xs={12} sm={6} md={3}>
            <StatCard
              ...
              value={dashboardData.stats.currentStudents || 0}
              icon={<PeopleIcon sx={{ fontSize: 28, color: theme.palette.secondary.main }} />}
              color={theme.palette.secondary.main}
              subtitle="Not enrolled yet"
              trend={0}
              badge={dashboardData.stats.currentStudents > 0 ? dashboardData.stats.currentStudents : null}
              onClick={() => navigate('/counselor/students')}
            />
          </Grid>
        </Grid>
            ...
            {activeTab === 0 && (
              <Grid container spacing={4}>
                ...
                <Grid item xs={12} lg={8}>
                  <ProgressOverview students={dashboardData.recentStudents} countryProgress={dashboardData.countryProgress} />
                </Grid>
