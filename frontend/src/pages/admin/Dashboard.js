        ...
        <Box sx={{ mb: 4 }}>
          <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, justifyContent: 'space-between', alignItems: { xs: 'flex-start', md: 'center' }, mb: 3 }}>
            <Box sx={{ width: '100%' }}>
              ...
              <Typography variant="h6" color="text.secondary" sx={{ fontWeight: 500, fontSize: { xs: '0.85rem', md: '1.25rem' }, lineHeight: 1.4 }}>
                Welcome back! Here's what's happening with your CRM system today.
              </Typography>
            </Box>
            <Stack direction="row" spacing={2} sx={{ mt: { xs: 2, md: 0 }, width: { xs: '100%', md: 'auto' }, flexWrap: 'wrap', gap: 1 }}>
              <FormControlLabel
                control={
                  <Switch
                    checked={autoRefresh}
              ...
              <Grid container spacing={3}>
                <Grid item xs={6} sm={3}>
                  <Box sx={{
                    ...
                    <Typography variant="h4" color="primary" sx={{ fontWeight: 800, mb: 1, fontSize: { xs: '1.5rem', md: '2.125rem' } }}>
                ...
                <Grid item xs={6} sm={3}>
                  <Box sx={{
                    ...
                    <Typography variant="h4" color="success.main" sx={{ fontWeight: 800, mb: 1, fontSize: { xs: '1.5rem', md: '2.125rem' } }}>
                ...
                <Grid item xs={6} sm={3}>
                  <Box sx={{
                    ...
                    <Typography variant="h4" color="warning.main" sx={{ fontWeight: 800, mb: 1, fontSize: { xs: '1.5rem', md: '2.125rem' } }}>
                ...
                <Grid item xs={6} sm={3}>
                  <Box sx={{
                    ...
                    <Typography variant="h4" color="error.main" sx={{ fontWeight: 800, mb: 1, fontSize: { xs: '1.5rem', md: '2.125rem' } }}>
